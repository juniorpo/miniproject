                  ...
                  <div class="row">
                      <div class="col-md-8">                      
                        <div class="form-group">
                            ...
                            <input type="textbox" class="form-control" name="item_no" id="imput_item_no" placeholder="enter item_no" autofocus>
                         </div>
                        <div class="form-group">
                          <label for="item_name">item_name</label>
                          <input type="textbox" class="form-control" name="item_name" id="imput_item_name" placeholder="enter item_name">
                        </div>
                        <div class="form-group">
                          <label for="item_no">price</label>
                          <input type="textbox" class="form-control" name="price" id="imput_price" placeholder="enter price">
                        </div>
                        <div class="form-group">
                          <label for="location">location</label>
                          <input type="textbox" class="form-control" name="location" id="imput_location" placeholder="enter location">
                        </div>
                        <div class="form-group">
                          <label for="qty_on_hand">qty_on_hand</label>
                          <input type="textbox" class="form-control" name="qty_on_hand" id="imput_qty_on_hand" placeholder="enter qty_on_hand">
                        </div>
                        <div class="form-group">
                          <label for="reorder_pt">reorder_pt</label>
                          <input type="textbox" class="form-control" name="reorder_pt" id="imput_reorder_pt" placeholder="enter reorder_pt">
                        </div>       
                        <div class="form-group">
                            <?php
                            include "../config.php";
                            ...
                            <select onclick="showSuppliers(this.value)" class="form-control" name="sup_no">
                                <?php  while($row=mysqli_fetch_assoc($result))
                                  { 
                                      echo "<option value='".$row["sup_no"]."'>".$row["sup_company"]."</option>";
                                  }
                                ?>
                            </select>
                            <div id="txtHint">Suppliers info will be listed here...</div>
                        </div>                
                      </div>
                      <div class="col-md-4">      
                        <div class="form-group">
