          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Sale Order Data</h3> 
                 </div>
                  <div class="card-header">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  $result = mysqli_query($conn," SELECT * FROM sales_orders WHERE order_status='sale_order' ORDER BY so_no DESC"); 
                    ...
                    <?php 
                     echo "<td>"; echo "<a href='sale_order_show.php?so_no=".$row['so_no']."'><button class='btn btn-success'>Show</button></a>";  
                     echo "</td>";
