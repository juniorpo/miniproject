                ...
                <div class="col-12">
                  <div class="card">
                    <div class="card-header">
                      ...
                      <div class="col-12">
                          <div class="card-header">
                            <a class="btn btn-success" href="quotation_print.php?so_no=<?php echo $so_no;?>" role="button"> Print </a>
                            <a class="btn btn-secondary" href="quotation_list.php" role="button"> Cancel </a>
                            <a class="btn btn-primary" href="quotation_confirm.php?so_no=<?php echo $so_no;?>" role="button"> Confirm to Sale Order </a>
                          </div>
                      </div>
                      <!-- /.card-header -->
                    <!-- /.card-body -->
