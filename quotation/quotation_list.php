            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Quotation Data</h3> 
                  ...
                  <div class="card-header">
                            <a class="btn btn-success" href="quotation_form.php" role="button">Add New Quotation</a>
                 </div>
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  $result = mysqli_query($conn," SELECT * FROM sales_orders WHERE order_status='quotation' ORDER BY so_no DESC"); 
                      ...
                      {  
                        ...
                        echo "<td>"; echo $row['cust_no']; echo "</td>";
                        echo "<td>"; echo $row['cust_po_no']; echo "</td>";
                        $newDate = date("d-m-Y", strtotime($row['cust_po_date']));
                        echo "<td>"; echo $newDate;; echo "</td>";
                        echo "<td>"; echo $row['ship_via']; echo "</td>";
                        echo "<td>"; echo $row['fob_term']; echo "</td>";
                        ?>
                    <!-- <td><button type="button" class="btn btn-success editbtn" > Show </button></td> -->
                    <?php 
                     echo "<td>"; echo "<a href='quotation_show.php?so_no=".$row['so_no']."'><button class='btn btn-success'>Show</button></a>";  
                     echo "</td>";
                     echo "<td>"; echo "<a href='quotation_delete.php?so_no=".$row['so_no']."' onclick='return chkConfirm();'><button class='btn btn-danger'>Delete</button></a>";  
                    echo "</td>";
                    ?>
                  </tr>
                  </tr>
