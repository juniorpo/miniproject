                  ...
                  <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                                                        ...
                                                        <input class="form-control" type="date" name="so_date" value="<?php echo $currentDate;?>"></div>
                                                        <div class="form-group">
                                                        <label class="col-form-label">Customer PO</label> 
                                                        <input class="form-control" type="text" name="cust_po_no" ></div>
                                                        <div class="form-group">
                                                        <label class="col-form-label">Customer PO Date</label> 
                                                        <input class="form-control" type="date" name="cust_po_date" value="<?php echo $currentDate;?>"></div>
                          </div>
                         <div class="col-md-6">
                                                        <div class="form-group">
                                                        <label class="col-form-label">Customer</label> 
                                                          ...
                                                          <select name="cust_no" onchange="showCustomer(this.value)" class="form-control select2"  style="width: 100%;">
                                                          
                                                          <?php 
                                                                echo "<option value='no customer'>Please select customer</option>";
                                                                while($row = mysqli_fetch_array($result))
                                                                 {  
                                                                echo "<option value='".$row['cust_no']."'>".$row['cust_no']."</option>";
                                                        ...
                                                        <div id="txtHint">Customer info will be listed here...</div>
                                                            ...
                                                            function showCustomer(str) {
                                                              ...
                                                              xhttp.open("GET", "getcustomer.php?cust_no="+str, true);
                                                              xhttp.send();
                                                            }
                                                            </script>
                                                        ...
                                                        <input class="form-control" type="text" name="ship_via" ></div>
                                                        <div class="form-group">
                                                        <label class="col-form-label">Fob Term</label> 
                                                        <input class="form-control" type="text" name="fob_term" ></div>
                          </div>
                    </div>  <!-- class row -->
