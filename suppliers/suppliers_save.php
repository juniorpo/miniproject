...
<?php
 ...
 $sql = "  UPDATE suppliers SET sup_no='$sup_no',
            sup_company='$sup_company',sup_contact='$sup_contact',
             sup_telephone='$sup_telephone',sup_email='$sup_email'
