...
<head>
  ...
  <title>AdminLTE 3 | quotation_list</title>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  $result = mysqli_query($conn," SELECT * FROM purchase_orders WHERE order_status='quotation' ORDER BY po_no DESC"); 
                      while($row = mysqli_fetch_array($result))
                      {  
                        echo "<tr>";
                        echo "<td>"; echo "PO".$row['po_no']; echo "</td>";
                          $newDate = date("d-m-Y", strtotime($row['po_date']));
                        echo "<td>"; echo $newDate;; echo "</td>";
                        echo "<td>"; echo $row['sup_no']; echo "</td>";
