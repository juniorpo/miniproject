<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link">
      ...
      <span class="brand-text font-weight-light">MyCompany V 0.1</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          ...
          <a href="#" class="d-block"><?php if(isset($_SESSION["user_login"])) echo $_SESSION["user_name"]; ?></a>
               ...
               <?php 
                  ...
                  if(isset($_SESSION['user_login']))
                  {
                    ...
                    <li class="nav-header">SALE</li>
                      <li class="nav-item">
                          <a href="../quotation/quotation_list.php" class="nav-link">
                            <i class="fas fa-circle nav-icon"></i>
                            <p>Quatation</p>
                          </a>
                        </li>
                      <li class="nav-item">
                        <a href="../quotation/sale_order_list.php" class="nav-link">
                          <i class="fas fa-circle nav-icon"></i>
                          <p>Sale Order</p>
                        </a>
                      </li>
                      ...
                      <li class="nav-item">
                          <a href="../inventory/inventory_list.php" class="nav-link">
                            <i class="fas fa-circle nav-icon"></i>
                            <p>Inventory</p>
                          </a>
                        </li>
                      <li class="nav-item">
                          <a href="../inventory/inventory_barchart.php" class="nav-link">
                            <i class="fas fa-circle nav-icon"></i>
                            <p>Report Quantity on Hand</p>
                          </a>
                        </li>
                        <li class="nav-item">
                          <a href="../inventory/inventory_donut.php" class="nav-link">
                            <i class="fas fa-circle nav-icon"></i>
                            <p>Report Ratio of Suppliers</p>
                          </a>
                        </li>
                      </li>
                      <?php
                  ...
                  if(isset($_SESSION['user_login']))
                  {
                    $checkuser = checkuser($_SESSION['user_login'],'purchase');
                    if($checkuser=="yes")
                    {
                      ?>
...
<?php 
                  if(isset($_SESSION['user_login']))
                  {
                    $checkuser = checkuser($_SESSION['user_login'],'warehouse');
                    if($checkuser=="yes")
                    {
                      ?>
                      <li class="nav-header">WAREHOUSE</li>
                      <li class="nav-item">
                          <a href="../warehouse/stock_move_list.php" class="nav-link">
                            <i class="fas fa-circle nav-icon"></i>
                            <p>Stock Move</p>
                          </a>
                        </li>           
